...
function Header() {
  ...
  <Link key={index} href={link.href} className="text-white transition hover:text-slate-300 ">
    {link.label}
  </Link>
))}
                </ul>
                ...
                {/* {status === "unauthenticated" && (
                  <> */}
                    ...
                    <div className="hidden sm:flex">
                      <Link
                        href={"/register"}
                        className="rounded-md bg-gray-100 px-5 py-2 text-sm font-medium text-blue-600 hover:bg-blue-600 hover:text-white"
                      >
  ...
  <Link key={index} href={drop.href} className="px-4 ">
    <MenuItem>{drop.label}</MenuItem>
  </Link>
))}
                              </details>
